...
class ConnectionHandler:
    def generate_auth_header(self, username, password):
        client_digest = hmac.new(
            password.encode(), msg=b"silenttrinity", digestmod=sha512
        ).hexdigest()
    ...
    def __init__(self, options, *args, **kwargs) -> None:
        ...
        self._listener_types = {
            SilentTriHTTPListenerType.name: SilentTriHTTPListenerType(
                self.options["teamserver_url"], self
            ),
        }
        self._launcher_types = {
            SilentTriPowershellLauncherType.name: SilentTriPowershellLauncherType(
                self.options["teamserver_url"], self
            ),
        }
...
class SilentTriHTTPListenerType(ListenerType):
    ...
    async def create_listener(self, options: Options, dto: RequestDto) -> Dict:
        ...
        set_port = {
            ...
            "ctx": "listeners",
            "cmd": "set",
            "args": {"name": "Port", "value": str(_bindPort)},
            "data": {},
        }
        ...
        set_iface = {
            ...
            "ctx": "listeners",
            "cmd": "set",
            "args": {"name": "BindIP", "value": _bindIp},
            "data": {},
        }
        ...
        listener = CreateListenerDto(
            listener_internal_id=result["name"], listener_options=options
        )
        dto = ResponseDto(successful_transaction=True, created_listener=listener)
        return dto
    ...
    async def delete_listener(
        ...
        stop_listener = {
            ...
            "ctx": "listeners",
            "cmd": "stop",
            "args": {"name": listener_internal_id},
            "data": {},
        }
...
class SilentTriPowershellLauncherType(LauncherType):
    ...
    async def create_and_retrieve_launcher(self, options: Options, dto: RequestDto):
        ...
        set_powershell_stagless = {
            "id": gen_random_string(),
            "ctx": "stagers",
            "cmd": "use",
            "args": {"name": "powershell_stageless"},
            "data": {},
        }
        ...
        dto = ResponseDto(successful_transaction=True, created_launcher=launcher)
        return dto
...
class PowershellAgentType(AgentType):
    ...
    async def shell_execute(
        ...
        set_cmd = {
            ...
            "ctx": "modules",
            "cmd": "set",
            "args": {"name": "command", "value": command},
            "data": {},
        }
        ...
        set_run = {
            ...
            "ctx": "modules",
            "cmd": "run",
            "args": {"guids": [shell_dto.agent_internal_id]},
            "data": {},
        }

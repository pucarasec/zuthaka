...
class C2Filter(filters.FilterSet):
    created_since = filters.IsoDateTimeFilter(field_name='creation_date', lookup_expr='gte')
    created_until = filters.IsoDateTimeFilter(field_name='creation_date', lookup_expr='lte')
